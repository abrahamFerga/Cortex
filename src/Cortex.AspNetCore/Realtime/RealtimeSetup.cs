...
namespace Cortex.AspNetCore.Realtime;
...
public static class RealtimeSetup
{
    ...
    public const string RedisConnectionName = "cortex-redis";

    public static ISignalRServerBuilder AddCortexRealtime(this IServiceCollection services, IConfiguration configuration)
    {
