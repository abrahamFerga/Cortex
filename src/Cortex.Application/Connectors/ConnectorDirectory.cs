...
/// <summary>
/// The directory of first-party connectors that exist in the Cortex ecosystem — including ones
...
public static class ConnectorDirectory
{
    ...
    private const string BundlePackage = "Cortex.Connectors";
    private const string BundleRegistration = "builder.AddCortexConnectors()";
    ...
    [
        ...
        new("documenso", "Documenso e-signature",
            ...
            BundlePackage, BundleRegistration),
        new("cortex-peer", "Cortex peer",
            "Talk to another Cortex-based system — how separate verticals exchange data as peers.",
            BundlePackage, BundleRegistration),
    ];
}
