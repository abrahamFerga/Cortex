...
{
    public static IHostApplicationBuilder AddCortexConnectors(this IHostApplicationBuilder builder) =>
        builder.AddCortexConnectorsFrom(typeof(BuiltInConnectors).Assembly);
}
