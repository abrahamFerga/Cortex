...
/**
 * The outermost render-error guard for the Cortex frontend. {@link TabErrorBoundary} contains a crash within a
...
> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo): void {
    ...
    console.error("Cortex: the application shell failed to render", error, info.componentStack);
  }
