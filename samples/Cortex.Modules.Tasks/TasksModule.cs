...
namespace Cortex.Modules.Tasks;

/// <summary>
/// The smallest useful Cortex module: a to-do list. It is the worked example behind
...
public sealed class TasksModule : IModule
{
    ...
    public ModuleManifest Manifest { get; } = new()
    {
        ...
        DisplayName = "Tasks",
        Version = "1.0.0",
        Description = "A minimal to-do module — the worked example for building your own Cortex vertical.",
        Icon = "check-square",
        AgentInstructions =
