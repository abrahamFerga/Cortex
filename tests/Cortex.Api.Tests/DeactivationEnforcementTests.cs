...
/// </summary>
public sealed class DeactivationEnforcementTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public DeactivationEnforcementTests(CortexApiFactory factory) => _factory = factory;
