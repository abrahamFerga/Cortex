...
/// </summary>
public sealed class TenantDataIsolationTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public TenantDataIsolationTests(CortexApiFactory factory) => _factory = factory;
    ...
    public async Task Admin_user_listing_is_scoped_to_the_callers_tenant()
    {
        ...
        Assert.Contains("dev@cortex.local", body);
    }
