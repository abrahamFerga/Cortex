...
/// </summary>
public sealed class AgentToolAuthorizationTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public AgentToolAuthorizationTests(CortexApiFactory factory) => _factory = factory;
