...
/// </summary>
public sealed class NotificationPreferenceTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public NotificationPreferenceTests(CortexApiFactory factory) => _factory = factory;
