...
/// refuse to run it.
/// </summary>
public sealed class AgentApprovalRoutingTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public AgentApprovalRoutingTests(CortexApiFactory factory) => _factory = factory;
