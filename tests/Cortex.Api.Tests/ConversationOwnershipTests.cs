...
/// </summary>
public sealed class ConversationOwnershipTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public ConversationOwnershipTests(CortexApiFactory factory) => _factory = factory;
