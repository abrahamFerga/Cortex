...
# module: database
# -----------------------------------------------------------------------------
# PostgreSQL Flexible Server (v16) hosting TWO databases:
#   - cortex_platform : operational data
#   - cortex_audit    : append-only audit log
# The admin password is generated (random_password) and surfaced as an output so
# the keyvault module can store it as a secret. Optional AAD admin + firewall.
# =============================================================================
